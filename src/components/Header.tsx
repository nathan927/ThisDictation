      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        {isAuthenticated ? (
          <div className="flex items-center gap-2 sm:gap-6">
            <span className="bg-gradient-to-r from-violet-400 via-fuchsia-500 to-indigo-500 bg-clip-text text-transparent text-base sm:text-lg font-bold animate-gradient hover:scale-105 transition-transform duration-300 px-1 truncate max-w-[120px] sm:max-w-none">
