...
const resources = {
  en: {
    translation: {
      ...
      'Are you sure you want to delete all words?': 'Warning: This will permanently delete all words. Your word sets will remain empty even after you log in again. Please consider to use "Export" function for backup.Now are you sure you want to proceed?',
      ...
      'Logged out Already': 'Logged out Already',
  ...
  'zh-TW': {
    translation: {
      ...
      'Are you sure you want to delete all words?': '警告：這將永久刪除所有詞組。即使您再次登入，詞組清單也會保持空白。您可先用"匯出"功能備份。現在您確定要繼續嗎？',
  ...
  'zh-CN': {
    translation: {
      ...
      'Are you sure you want to delete all words?': '警告：这将永久删除所有词组。即使您再次登录，词组清单也会保持空白。您可先用"导出"功能备份。现在您确定要继续吗？',
