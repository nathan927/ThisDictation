...
const resources = {
  en: {
    translation: {
      ...
      'Please click "Play" twice in the first time.': 'for PC version, please click "Play" twice in the first time.',
  ...
  'zh-TW': {
    translation: {
      ...
      'Please click "Play" twice in the first time.': 'PC版本第一次使用時請按兩次「播放」。',
      'Take Photo': '拍照片',
      'Select a file': '選擇檔案'
    }
  },
  'zh-CN': {
    translation: {
      ...
      'Please click "Play" twice in the first time.': 'PC版本第一次使用时请按两次「播放」。',
      'Take Photo': '拍照片',
      'Select a file': '选择文件'
    }
  }
